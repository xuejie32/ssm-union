    ...
    <div id="top-header">
        <div class="container">
            ...
            <ul class="header-links pull-right">
                <li><a href="shouye"><i class="fa fa-dollar"></i> 首页</a></li>
                    ...
                    <div class="header-search">
                        <form>
                            <select class="input-select">
                                ...
                                <option value="1">充气娃娃</option>
                            </select>
                            <input class="input" placeholder="请输入商品名">
        ...
        <div class="row">
            ...
            <div id="store" class="col-md-9">
                ...
                <div class="row">
                    ...
                    <!-- product -->
                    <div class="col-md-4 col-xs-6" style="margin-top: 50px">
                        <div class="product">
                            <div class="product-img">
                                <img src="${pageContext.request.contextPath }/${pro.pimage}" width="200px"  alt="">
